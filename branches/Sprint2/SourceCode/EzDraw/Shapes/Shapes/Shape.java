...
public abstract class Shape {
    ...
    /**
     * Calls the Shapes.IAttachable to calculate snap points
     */
    public void drawAttachmentSections() {
        ...
        */
        ...
        for (int i = 0; i < (sections.length); i += 4) {
            ...
            System.out.println("Shapes.Rectangle drawn at X: " + sections[i]
    ...
    /**
     * Set the attachment strategy (Shapes.IAttachable) for the shape
     *
